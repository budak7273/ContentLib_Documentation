...
ContentLib makes it easier to do a lot of things,
but it will never be a replacement for the full Satisfactory modding suite.
...
a|
* ✔️ Create new items, recipes, and schematics (ex. HUB Milestones)
* ✔️ Modify properties of existing items, recipes, and schematics
* ✔️ Change or add new icons for items and schematics
* ✔️ Modify some properties of machines, equipment, creatures, etc.
* ✔️ Modify some data assets created by other mods
* ✔️ Hot reload some content without restarting the game (WIP)
* ✔️ Be extended by other mods to dynamically generate content
* ✔️ Enable writing mods that need few, if any, updates (ContentLib JSON structure is consistent across updates)
a|
...
To learn more about the full modding toolkit,
which does not have these limitations,
see the https://docs.ficsit.app/satisfactory-modding/latest/index.html[Satisfactory Modding Documentation].
