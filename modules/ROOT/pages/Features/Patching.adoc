...
xref:Tutorials/FindAssetPath.adoc[This page]
covers how to find the path of an asset.
...
Here's an example schematic patch from RePan that replaces the unlocks of an existing schematic with another set:
